...
public class DetalhesSerie extends javax.swing.JDialog {

    public DetalhesSerie(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        DefaultTableModel modelserie = (DefaultTableModel) jTable1.getModel();
        DefaultTableModel modelelenco = (DefaultTableModel) jTable2.getModel();
        
        modelserie.setNumRows(0);
        modelelenco.setNumRows(0);
        
        for (Serie s : globalVariablesLists.seriesTV){
            modelserie.addRow(new Object[]{s.getClassificacaoIndicativa(),s.getGenero(),s.getIdioma(),s.getDiretor(),s.getDistribuidora(),s.getAno(),s.getDuracao()});
        }
               
        for (Serie s : globalVariablesLists.seriesTV){
            modelelenco.addRow(new Object[]{s.getElenco()});
        }
        
       for (Serie s : globalVariablesLists.seriesTV){
           jTextAreaSinopse.setText(s.getSinopse());
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Detalhes Serie");
