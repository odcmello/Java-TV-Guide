...
public class SugestaoWordImplementation implements ClienteSugestao<JTextComponent> {
  private Function<String, List<String>> suggestionProvider;

  public SugestaoWordImplementation(Function<String, List<String>> suggestionProvider) {
