...
public class DetalhesOutro extends javax.swing.JDialog {

    public DetalhesOutro(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        DefaultTableModel modeloutro = (DefaultTableModel) jTable1.getModel();
        DefaultTableModel modelelenco = (DefaultTableModel) jTable2.getModel();
        
        modeloutro.setNumRows(0);
        modelelenco.setNumRows(0);
        
        for (Outro o : globalVariablesLists.outrosTV){
            modeloutro.addRow(new Object[]{o.getClassificacaoIndicativa(),o.getGenero(),o.getIdioma(),o.getDiretor(),o.getDistribuidora(),o.getAno(),o.getDuracao()});
        }
               
        for (Outro o : globalVariablesLists.outrosTV){
            modelelenco.addRow(new Object[]{o.getElenco()});
        }
        
        for (Outro o : globalVariablesLists.outrosTV){
           jTextAreaSinopse.setText(o.getSinopse());
        }
